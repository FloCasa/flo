...
define('APP_TITLE', 'insertion');

$dauth = false;

$auth_users = array(
    'admin' => 'e0e39b991692259764469b25bfe10b47',
    'user' => 'e0e39b991692259764469b25bfe10b47'
);
...
if ( !defined( 'DN_CESSION_ID')) {
    define('DN_CESSION_ID', 'insertion');
}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> insertion <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">insertion <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">insertion <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'insertion<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="insertion">
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'insertion';      $tr['en']['AppTitle']           = 'insertion';
